...
2. **The Office — prices** (same product, three prices)
   ...
   - **One-time** → `$197` → Netlify `STRIPE_PRICE_OFFICE`
...
Default script amounts: Office one-time **$197**, monthly **$49**, yearly **$397**, HOTMESS **$97** (change anytime in Stripe).
...
| The Office one-time | `/pricing` → Buy once | one-time `payment` | Webhook sets membership → portal unlocks |
